package bitcoinviewver.grafici;
...
public class GraficoZoomabile<X, Y> {
    ...
    public GraficoZoomabile(final Pane chartParent, final XYChart<X, Y> chart,
        ...
        zoomRect.setFill(Color.WHITE.deriveColor(0, 1, 1, 0.25));
        chartParent.getChildren().add(zoomRect);
        setUpZooming(zoomRect, chart);

    }

    public GraficoZoomabile(final Pane chartParent, final XYChart<X, Y> chart, final Series<X, Y>... series) {
